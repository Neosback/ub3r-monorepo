...
class ArchitectureBoundaryTest {
    ...
    fun `required content toml files for migrated skills exist`() {
        ...
        val requiredToml = listOf(
            ...
            "game-server/src/main/resources/content/skills/objects/farming.toml",
    ...
    fun `declarative content files exist for migrated modules`() {
        val requiredResources = listOf(
            ...
            sourceRoot.resolve("resources/content/skills/objects/crafting.toml"),
            sourceRoot.resolve("resources/content/skills/objects/cooking.toml"),
            sourceRoot.resolve("resources/content/skills/objects/smithing.toml"),
            sourceRoot.resolve("resources/content/skills/objects/farming.toml"),
