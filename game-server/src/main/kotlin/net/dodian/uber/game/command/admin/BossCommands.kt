...
private fun handleBoss(context: CommandContext): Boolean {
    ...
    if (context.alias == "forcetask" && (specialRights || gameWorldId > 1)) {
        return try {
            ...
            val length = net.dodian.uber.game.skill.slayer.SlayerTaskDefinition.VALUES.size - 1
            ...
            val task = net.dodian.uber.game.skill.slayer.SlayerTaskDefinition.forOrdinal(taskId) ?: return false
