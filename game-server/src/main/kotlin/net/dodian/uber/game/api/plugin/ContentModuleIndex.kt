...
object ContentModuleIndex {
    ...
    /** Canonical roots plus legacy compatibility roots while migration is in-flight. */
    ...
    init {
        ...
        logger.info(
            "Plugin index {}: buttons={}, objects={}, items={}, commands={}, npcs={}, skills={}, shops={}, events={}, bootstraps={}, catalog={}",
