...
import net.dodian.uber.game.engine.systems.skills.protocolClient
...
class SkillObjectInteraction(val player: SkillPlayer, val option: Int, val objectId: Int, val position: Position, val definition: GameObjectData?) {
    @Deprecated("Legacy Client destructuring; use player capabilities instead.", level = DeprecationLevel.WARNING)
    internal operator fun component1() = player.protocolClient()
