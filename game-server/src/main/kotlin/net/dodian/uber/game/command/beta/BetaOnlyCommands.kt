package net.dodian.uber.game.command.beta
...
import net.dodian.uber.game.command.dev.handleFarmTest
import net.dodian.uber.game.command.dev.handleSkillBank
import net.dodian.uber.game.command.dev.handleSkillSet
import net.dodian.uber.game.command.dev.handleSkillTools
import net.dodian.uber.game.command.dev.handleSlayerTest
