...
import net.dodian.uber.game.objects.travel.dialogue.BrimhavenEntryDialogueOptionHandler
...
//                    }
        ...
        if (c.convoId == 3) {
            if (button == 1) {
                c.openUpShopRouted(ShopId.AUBURYS_MAGIC_STORE.id)
            } else {
                c.send(RemoveInterfaces())
            }
        }
        ...
        if (c.convoId == 4) {
            if (button == 1) {
                c.openUpShopRouted(ShopId.LEGACY_SHOP_22.id)
            } else {
                c.send(RemoveInterfaces())
            }
        }
        ...
        if (dialogueId == 163) {
            ...
            if (button == 1) {
                c.send(RemoveInterfaces())
                c.openUpShop(ShopId.JATIX_HERBLORE_STORE.id)
            } else if (button == 2) {
            ...
            if (button == 1) {
                c.send(RemoveInterfaces())
                c.openUpShop(ShopId.CHRISTMAS_EVENT_STORE.id)
            } else {
                c.send(RemoveInterfaces())
            }
            ...
            if (button == 1) {
                c.send(RemoveInterfaces())
                c.openUpShopRouted(ShopId.LEGACY_SHOP_19.id)
            } else if (button == 2) {
