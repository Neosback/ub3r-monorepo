package net.dodian.game.model.player.quests
...
enum class QuestSend(
    ...
    companion object {
        ...
        @JvmStatic
        fun getSender(button: Int): QuestSend? {
        ...
        @JvmStatic
        fun questInterface(client: Client): QuestSend? {
        ...
        @JvmStatic
        fun serverInterface(client: Client): QuestSend? = serverInterface(client, getCachedUptimeText())

        @JvmStatic
        fun serverInterface(client: Client, uptimeText: String): QuestSend? {
        ...
        fun questMenu(client: Client, button: Int): Boolean {
            ...
            if (client.questPage == 0 && quest != null) {
                ...
                when (button) {
                    7332 -> {
                        client.sendString("@dre@Dodian Server 3.0 - Boss Log", 8144)
                        client.clearQuestInterface()
                        var line = 8145
                    ...
                    7333 -> {
                        client.sendString("@dre@Dodian Server 3.0 - Monster Log", 8144)
                        client.clearQuestInterface()
                        var line = 8145
                    ...
                    7334 -> {
                        client.sendString("@dre@Dodian Server 3.0 - Commands", 8144)
                        client.clearQuestInterface()
                        var line = 8145
                        val commands =
                            arrayOf(
