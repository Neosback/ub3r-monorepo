package net.dodian.game.systems.world.npc

import java.util.TreeMap
import net.dodian.game.content.npcs.spawns.NpcContentRegistry
import net.dodian.game.content.npcs.spawns.NpcSpawnDef
import net.dodian.game.model.Position
import net.dodian.uber.game.model.entity.npc.Npc
import net.dodian.uber.game.model.entity.npc.NpcData
import net.dodian.uber.game.model.entity.player.Client
import net.dodian.game.persistence.world.npc.NpcDataRepository
...
class NpcManager {
    ...
    fun createNpc(id: Int, position: Position, face: Int): Npc {
        ...
        nextIndex++
        if (net.dodian.game.Server.chunkManager != null) {
