...
fun Client.checkSlayerTask(npcId: Int): Boolean {
    val slayerTask = net.dodian.game.content.skills.slayer.SlayerTaskDefinition.forNpc(npcId)
    val slayExceptions = (slayerTask == null)
            || (slayerTask == net.dodian.game.content.skills.slayer.SlayerTaskDefinition.MUMMY && getPositionName(position) == Player.positions.KEYDUNG)
