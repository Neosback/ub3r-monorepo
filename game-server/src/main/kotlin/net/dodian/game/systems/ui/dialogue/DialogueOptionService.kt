package net.dodian.game.systems.ui.dialogue
...
import net.dodian.game.content.skills.agility.AgilityDefinitions
...
import net.dodian.game.content.skills.thieving.plunder.PyramidPlunderService
...
//                    }
        ...
        if (dialogueId == 16) {
            if (button == 1) {
                val checkTask = net.dodian.game.content.skills.slayer.SlayerTaskDefinition.forOrdinal(c.slayerData[1])
                if (checkTask != null) {
