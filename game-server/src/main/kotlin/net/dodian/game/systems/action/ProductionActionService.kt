...
import net.dodian.game.content.skills.core.runtime.sendFilterMessage
import net.dodian.game.content.skills.core.runtime.ProductionSpec
import net.dodian.game.content.skills.core.runtime.ProductionTask
...
object ProductionActionService {
    ...
    @Deprecated(
        ...
        replaceWith = ReplaceWith(
            ...
            imports = arrayOf("net.dodian.game.systems.api.content.ContentActions"),
        ),
    )
    fun queueSelection(
        client: Client,
