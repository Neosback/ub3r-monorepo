package net.dodian.game.systems.action.dsl

import java.util.concurrent.ExecutorService
import java.util.concurrent.atomic.AtomicBoolean
import java.util.concurrent.atomic.AtomicReference
import kotlin.coroutines.cancellation.CancellationException
import net.dodian.game.content.skills.core.events.SkillActionCompleteEvent
import net.dodian.game.content.skills.core.events.SkillActionInterruptEvent
import net.dodian.game.content.skills.core.events.SkillActionStartEvent
import net.dodian.game.content.skills.core.requirements.Requirement
import net.dodian.game.content.skills.core.requirements.ValidationResult
import net.dodian.game.content.skills.core.runtime.ActionStopReason
import net.dodian.game.content.skills.core.runtime.ActionStopReasonMapper
import net.dodian.game.event.GameEventBus
import net.dodian.game.event.events.skilling.SkillingActionCycleEvent
import net.dodian.game.event.events.skilling.SkillingActionStartedEvent
import net.dodian.game.event.events.skilling.SkillingActionStoppedEvent
import net.dodian.game.event.events.skilling.SkillingActionSucceededEvent
import net.dodian.uber.game.model.entity.player.Client
import net.dodian.uber.game.netty.listener.out.SendMessage
import net.dodian.game.persistence.DbDispatchers
import net.dodian.game.persistence.repository.DbResult
import net.dodian.game.systems.action.PlayerActionCancelReason
import net.dodian.game.systems.action.PlayerActionContext
import net.dodian.game.systems.action.PlayerActionController
import net.dodian.game.systems.action.PlayerActionInterruptPolicy
