package net.dodian.game.content.objects

import net.dodian.cache.`object`.GameObjectData
import net.dodian.game.content.objects.services.ObjectInteractionContext
import net.dodian.game.content.objects.services.ObjectInteractionType
import net.dodian.game.event.GameEventBus
import net.dodian.game.event.events.ObjectClickEvent
import net.dodian.game.model.Position
import net.dodian.uber.game.model.entity.player.Client
import net.dodian.game.systems.api.content.ContentDispatchTiming
