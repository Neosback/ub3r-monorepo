package net.dodian.game.content.commands.boss
...
private fun handleBoss(context: CommandContext): Boolean {
    ...
    if (context.alias == "forcetask" && (specialRights || gameWorldId > 1)) {
        return try {
            ...
            val length = net.dodian.game.content.skills.slayer.SlayerTaskDefinition.values().size - 1
            ...
            val task = net.dodian.game.content.skills.slayer.SlayerTaskDefinition.forOrdinal(taskId) ?: return false
