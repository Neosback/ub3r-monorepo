package net.dodian.game.content.skills.slayer
...
object SlayerService {
    ...
    fun mazchnaTasks(client: Client): ArrayList<SlayerTaskDefinition> =
        collectTasks(client, SlayerDefinitions.mazchna) { task ->
            when (task) {
