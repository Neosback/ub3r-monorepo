package net.dodian.game.content.objects.travel

import net.dodian.game.model.Position
import net.dodian.game.content.objects.dsl.VerticalTravelDslObjectContent
import net.dodian.game.content.objects.dsl.verticalTravelActions
