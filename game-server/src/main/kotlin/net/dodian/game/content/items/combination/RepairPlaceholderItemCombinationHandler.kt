package net.dodian.game.content.items.combination
...
object RepairPlaceholderItemCombinationHandler {
    ...
    fun handle(client: Client, itemUsed: Int, useWith: Int): Boolean {
        ...
        if ((itemUsed == 4938 && useWith == 4212) || (itemUsed == 4212 && useWith == 4938)) {
            client.sendMessage("WIP: Repair!")
            matched = true
        } else if ((itemUsed == 4936 && useWith == 6724) || (itemUsed == 6724 && useWith == 4936)) {
            client.sendMessage("WIP: Repair!")
            matched = true
        } else if (itemUsed == 4938 || useWith == 4938) {
            client.sendMessage("You need a Crystal bow to repair the Karil crossbow half way.")
            matched = true
        } else if (itemUsed == 4936 || useWith == 4936) {
            client.sendMessage("You need a Seercull bow to repair the Karil crossbow into full strength.")
            matched = true
        }
        ...
        if ((itemUsed == 4866 && useWith == 4675) || (itemUsed == 4675 && useWith == 4866)) {
            ...
            client.sendMessage("You need a Ancient staff to repair the Ahrim staff half way.")
            matched = true
        } else if (itemUsed == 4864 || useWith == 4864) {
            client.sendMessage("You need a Master wand to repair the Ahrim staff into full strength.")
            matched = true
        }
