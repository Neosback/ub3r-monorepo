package net.dodian.game.content.interfaces.crafting

object CraftingInterfaceComponents {
    const val LEATHER_INTERFACE_ID = 8880
    const val PRODUCTION_AMOUNT_INTERFACE_ID = 8888
    const val GLASS_INTERFACE_ID = 11462
    const val TANNING_INTERFACE_ID = 14670
    ...
    val productionAmountButtons = mapOf(10239 to 1, 10238 to 5, 6212 to 10, 6211 to 28)

    data class GlassProductBinding(
        val componentId: Int,
        val componentKey: String,
        val rawButtonIds: IntArray,
        val productId: Int,
