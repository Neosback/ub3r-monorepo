...
import net.dodian.game.content.skills.core.requirements.RequirementBuilder
...
import net.dodian.game.content.skills.core.runtime.SkillingRandomEventService
...
import net.dodian.game.systems.interaction.ObjectInteractionDistance
import net.dodian.game.persistence.audit.ItemLog
...
object WoodcuttingService {
    ...
    fun startWoodcutting(
        ...
        if (client.fletchingState != null || client.isFiremaking || client.craftingState?.mode == net.dodian.game.content.skills.crafting.CraftingMode.SHAFTING) {
            client.resetAction()
        }
