...
import net.dodian.game.content.skills.slayer.SlayerPlugin
import net.dodian.game.content.skills.slayer.SlayerTaskDefinition
...
internal object SlayerMasterDialogue {
    ...
    fun assignTask(client: Client, npcId: Int) {
        ...
        val tasks = when (npcId) {
            402 -> SlayerPlugin.tasksForMaster(client, 402)
            403 -> SlayerPlugin.tasksForMaster(client, 403)
            405 -> SlayerPlugin.tasksForMaster(client, 405)
            else -> emptyList()
        }
    ...
    fun showCurrentTask(client: Client) {
        ...
        val checkTask = SlayerTaskDefinition.forOrdinal(client.getSlayerData()[1])
    ...
    private fun net.dodian.game.systems.ui.dialogue.DialogueFactory.mainMenu(client: Client, npcId: Int) {
    ...
    private fun net.dodian.game.systems.ui.dialogue.DialogueFactory.cancelTaskFlow(client: Client, npcId: Int) {
        val taskName = currentTaskName(client)
    ...
    private fun net.dodian.game.systems.ui.dialogue.DialogueFactory.upgradeFlow(client: Client, npcId: Int) {
    ...
    private fun currentTaskName(client: Client): String {
        ...
        return SlayerTaskDefinition.forOrdinal(client.getSlayerData()[1])?.textRepresentation ?: ""
    }
}
