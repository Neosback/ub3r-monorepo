package net.dodian.game.content.commands.dev

import java.util.LinkedHashSet
import net.dodian.game.content.skills.cooking.CookingDefinitions
import net.dodian.game.content.skills.crafting.CraftingDefinitions
import net.dodian.game.content.skills.farming.FarmingDefinitions
import net.dodian.game.content.skills.fishing.FishingDefinitions
import net.dodian.game.content.skills.fletching.FletchingDefinitions
import net.dodian.game.content.skills.herblore.HerbloreDefinitions
import net.dodian.game.content.skills.mining.MiningDefinitions
import net.dodian.game.content.skills.smithing.SmithingFrameDefinitions
...
import net.dodian.game.content.skills.woodcutting.WoodcuttingDefinitions
...
object SkillTestItemCatalog {
    ...
    private fun thievingItems(): List<Int> {
        val items = LinkedHashSet<Int>()
        net.dodian.game.content.skills.thieving.ThievingDefinitions.all.forEach { data ->
