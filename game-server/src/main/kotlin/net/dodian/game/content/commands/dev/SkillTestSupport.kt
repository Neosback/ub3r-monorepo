...
import net.dodian.game.content.commands.CommandContext
...
import net.dodian.game.content.skills.core.progression.SkillAdminService
...
private fun resolveSlayerTask(raw: String): net.dodian.game.content.skills.slayer.SlayerTaskDefinition? {
    raw.toIntOrNull()?.let { return net.dodian.game.content.skills.slayer.SlayerTaskDefinition.forOrdinal(it) }
    val normalized = raw.trim().lowercase().replace(" ", "_")
    return net.dodian.game.content.skills.slayer.SlayerTaskDefinition.values().firstOrNull { task ->
