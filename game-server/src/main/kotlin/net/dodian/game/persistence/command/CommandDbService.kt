package net.dodian.game.persistence.command
...
object CommandDbService {
    ...
    fun computeSkillMutation(currentXp: Int, totalXp: Int, totalLevel: Int, requestedXp: Int): SkillMutationComputation {
        ...
        val newTotalLevel = totalLevel -
            net.dodian.game.model.player.skills.Skills.getLevelForExperience(currentXp) +
            net.dodian.game.model.player.skills.Skills.getLevelForExperience(newXp)
