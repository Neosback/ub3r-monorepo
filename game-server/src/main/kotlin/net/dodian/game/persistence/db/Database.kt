package net.dodian.game.persistence.db

import com.zaxxer.hikari.HikariConfig
import com.zaxxer.hikari.HikariDataSource
import net.dodian.game.config.databaseHost
import net.dodian.game.config.databaseName
import net.dodian.game.config.databasePassword
import net.dodian.game.config.databasePoolConnectionTimeout
import net.dodian.game.config.databasePoolIdleTimeout
import net.dodian.game.config.databasePoolMaxLifetime
import net.dodian.game.config.databasePoolMaxSize
import net.dodian.game.config.databasePoolMinSize
import net.dodian.game.config.databasePort
import net.dodian.game.config.databaseTablePrefix
import net.dodian.game.config.databaseUsername
