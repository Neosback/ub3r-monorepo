package net.dodian.game.engine.sync.viewport
...
import net.dodian.game.engine.sync.util.LongObjectMap
...
class ViewportIndex private constructor(
    ...
    companion object {
        ...
        private fun buildNeighborhood(
            chunkManager: net.dodian.game.model.chunk.ChunkManager,
            center: net.dodian.game.model.Position,
            distance: Int,
        ): ViewportSnapshot {
            val level = center.z
