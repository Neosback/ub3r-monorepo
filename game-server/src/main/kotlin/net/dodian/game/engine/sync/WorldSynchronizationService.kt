...
import net.dodian.game.engine.sync.cache.RootSynchronizationCache
import net.dodian.game.engine.sync.npc.NpcChunkActivityIndex
import net.dodian.game.engine.sync.npc.NpcSyncDecision
import net.dodian.game.engine.sync.npc.RootNpcDeltaIndex
import net.dodian.game.engine.sync.npc.ViewerNpcSyncState
import net.dodian.game.engine.sync.player.PlayerChunkActivityIndex
import net.dodian.game.engine.sync.player.PlayerSyncDecision
import net.dodian.game.engine.sync.player.PlayerSyncRevisionIndex
import net.dodian.game.engine.sync.player.ViewerPlayerSyncState
import net.dodian.game.engine.sync.playerinfo.RootPlayerInfoService
import net.dodian.game.systems.ui.PlayerUiDeltaProcessor
import net.dodian.game.engine.sync.viewport.ViewportIndex
import net.dodian.game.systems.zone.ZoneUpdateBus
import net.dodian.game.config.runtimePhaseWarnMs
...
class WorldSynchronizationService {
    ...
    private fun flushActivePlayers(activePlayers: List<Client>) {
        ...
        val zoneStatsRef = arrayOfNulls<net.dodian.game.systems.zone.ZoneFlushStats>(1)
        val zoneNanos =
            measureNanoTime {
        ...
        if (totalMs >= runtimePhaseWarnMs) {
            val zoneStats = zoneStatsRef[0] ?: net.dodian.game.systems.zone.ZoneFlushStats.EMPTY
            logger.warn(
