    ...
    public void UpdateNPCChat() {
        switch (NpcDialogue) {
            ...
            case 20:
                ...
                if (NpcTalkTo == 17)
                    carpet_options = new String[]{carpet_options[0], "Pollnivneach", "Nardah", "Bedabin Camp", carpet_options[carpet_options.length - 1]};
                else if (NpcTalkTo == 19)
                    carpet_options = new String[]{carpet_options[0], "Pollnivneach", "Nardah", "Sophanem", carpet_options[carpet_options.length - 1]};
                else if (NpcTalkTo == 20)
                    carpet_options = new String[]{carpet_options[0], "Nardah", "Bedabin Camp", "Sophanem", carpet_options[carpet_options.length - 1]};
                else if (NpcTalkTo == 22)
                    carpet_options = new String[]{carpet_options[0], "Pollnivneach", "Sophanem", "Bedabin Camp", carpet_options[carpet_options.length - 1]};
        ...
        if (NpcDialogue == 163) {
                ...
                if (!checkUnlock(0)) {
                    ...
                    if (missing > 0) {
                        if (getInvAmt(995) >= missing) {
                            ...
                            showNPCChat(NpcTalkTo, 591, new String[]{"You do not have enough coins to do this!", "You are currently missing " + (missing - getInvAmt(995)) + " coins or", (int) Math.ceil((missing - getInvAmt(995)) / 300_000D) + " ship tickets."});
            ...
            if (checkUnlockPaid(0) > 0 || checkUnlock(0)) {
                ...
                if (amount >= total) {
                    ...
                    showNPCChat(NpcTalkTo, 596, new String[]{"You need atleast " + (300_000 - amount) + " more coins to enter my dungeon!"});
            }
