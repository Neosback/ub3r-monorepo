...
object FletchingModule : SkillPlugin {
    ...
    val arrowRecipes: List<FletchingAmmoDefinition> by lazy { loadAmmunition("arrow") }
    val dartRecipes: List<FletchingAmmoDefinition> by lazy { loadAmmunition("dart") }
    ...
    private fun shaftRecipe(): SkillRecipe = skillRecipe("fletching.shafts", 52) {
        output(15); material(1511); requirement(1); experience(50); animation(1248); delay(2)
